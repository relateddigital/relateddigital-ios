//
//  RelatedDigitalRecommendation.swift
//  RelatedDigitalIOS
//
...
class RelatedDigitalRecommendation {
    let reladetDigitalProfile: RelatedDigitalProfile

    init(reladetDigitalProfile: RelatedDigitalProfile) {
        self.reladetDigitalProfile = reladetDigitalProfile
    }
    ...
    func recommend(zoneID: String,
        ...
        props[RelatedDigitalConstants.organizationIdKey] = reladetDigitalProfile.organizationId
        props[RelatedDigitalConstants.profileIdKey] = reladetDigitalProfile.profileId
        ...
        RelatedDigitalRequest.sendRecommendationRequest(properties: props,
                                                        ...
                                                        timeoutInterval: reladetDigitalProfile.requestTimeoutInterval,
