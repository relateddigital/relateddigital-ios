//
//  RelatedDigitalPersistence.swift
//  RelatedDigitalIOS
//
...
public class RelatedDigitalPersistence {
    ...
    class func unarchiveUser() -> RelatedDigitalUser {
        ...
        // Before RelatedDigital.identity is used as archive key, to retrieve RelatedDigital.cookieID set by objective-c library
        ...
        if let propsfp = filePath(filename: RelatedDigitalConstants.userArchiveKey),
           let props = NSKeyedUnarchiver.unarchiveObject(withFile: propsfp) as? [String: String?] {
            ...
            // TO_DO: relatedDigitalUserda ya üstteki kod gereksiz ya da alttaki yanlış
            ...
            RelatedDigitalLogger.warn("RelatedDigital: Error while unarchiving properties.")
        }
...
/* MARK: Geofence Modülüyle Beraber Açılacak
