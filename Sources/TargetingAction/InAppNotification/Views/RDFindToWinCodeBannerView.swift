...
class RDFindToWinCodeBannerView: UIView {

    var findToWinModel: FindToWinViewModel
    ...
    init(frame: CGRect, findToWin: FindToWinViewModel) {
        self.findToWinModel = findToWin
    ...
    private func setupLabels() {
        ...
        bannerTextLabel.text = findToWinModel.promocode_banner_text.removeEscapingCharacters()
        ...
        bannerButtonLabel.text = findToWinModel.promocode_banner_button_label
        bannerButtonLabel.textAlignment = .center
        bannerButtonLabel.isHidden = true

        bannerCodeLabel = UILabel()
        bannerCodeLabel.text = BannerCodeManager.shared.getFindToWinCode()
    ...
    private func setCloseButton() {
        ...
        closeButton.setTitleColor(findToWinModel.close_button_color.lowercased() == "white" ? .white : .black, for: .normal)
    ...
    private func setFonts() {
        let font = RDHelper.getFont(fontFamily: findToWinModel.font_family,
                                    fontSize: findToWinModel.copybutton_text_size,
                                    style: .title2, customFont: findToWinModel.custom_font_family_ios)
    ...
    private func setColors() {
        self.backgroundColor = UIColor(hex: findToWinModel.promocode_banner_background_color)
        horizontalStackView.backgroundColor = UIColor(hex: findToWinModel.promocode_banner_background_color)
        bannerTextLabel.backgroundColor = UIColor(hex: findToWinModel.promocode_banner_background_color)
        bannerButtonLabel.backgroundColor = UIColor(hex: findToWinModel.promocode_banner_background_color)
        bannerCodeLabel.backgroundColor = UIColor(hex: findToWinModel.promocode_banner_background_color)

        bannerTextLabel.textColor = UIColor(hex: findToWinModel.promocode_banner_text_color)
        bannerButtonLabel.textColor = UIColor(hex: findToWinModel.promocode_banner_text_color)
        bannerCodeLabel.textColor = UIColor(hex: findToWinModel.promocode_banner_text_color)
    }
