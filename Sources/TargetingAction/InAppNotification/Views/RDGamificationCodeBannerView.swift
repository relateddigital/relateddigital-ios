...
class RDGamificationCodeBannerView: UIView {
    ...
    private func setupLabels() {
        ...
        bannerTextLabel.text = gameficationModel.promocode_banner_text.removeEscapingCharacters()
        ...
        bannerButtonLabel.text = gameficationModel.promocode_banner_button_label
    ...
    private func setCloseButton() {
        ...
        closeButton.setTitleColor(gameficationModel.close_button_color.lowercased() == "white" ? .white : .black , for: .normal)
    ...
    private func setFonts() {
        let font = RDHelper.getFont(fontFamily: gameficationModel.font_family,
                                    fontSize: gameficationModel.copybutton_text_size,
                                    style: .title2, customFont: gameficationModel.custom_font_family_ios)
    ...
    private func setColors() {
        self.backgroundColor = UIColor(hex: gameficationModel.promocode_banner_background_color)
        horizontalStackView.backgroundColor = UIColor(hex: gameficationModel.promocode_banner_background_color)
        bannerTextLabel.backgroundColor = UIColor(hex: gameficationModel.promocode_banner_background_color)
        bannerButtonLabel.backgroundColor = UIColor(hex: gameficationModel.promocode_banner_background_color)
        bannerCodeLabel.backgroundColor = UIColor(hex: gameficationModel.promocode_banner_background_color)
        
        bannerTextLabel.textColor = UIColor(hex: gameficationModel.promocode_banner_text_color)
        bannerButtonLabel.textColor = UIColor(hex: gameficationModel.promocode_banner_text_color)
        bannerCodeLabel.textColor = UIColor(hex: gameficationModel.promocode_banner_text_color)
    }
