...
class RDJackpotCodeBannerView: UIView {
    ...
    init(frame: CGRect, jackpotModel: JackpotModel) {
        self.jackpotModel = jackpotModel
    ...
    private func setupLabels() {
        ...
        bannerTextLabel.text = jackpotModel.promocode_banner_text.removeEscapingCharacters()
        ...
        bannerButtonLabel.text = jackpotModel.promocode_banner_button_label
        bannerButtonLabel.textAlignment = .center

        bannerCodeLabel = UILabel()
        bannerCodeLabel.text = BannerCodeManager.shared.getJackpotCode()
    ...
    private func setCloseButton() {
        ...
        closeButton.setTitleColor(jackpotModel.close_button_color.lowercased() == "white" ? .white : .black, for: .normal)
    ...
    private func setFonts() {
        let font = RDHelper.getFont(fontFamily: jackpotModel.font_family,
                                    fontSize: jackpotModel.copybutton_text_size,
                                    style: .title2, customFont: jackpotModel.custom_font_family_ios)
    ...
    private func setColors() {
        self.backgroundColor = UIColor(hex: jackpotModel.promocode_banner_background_color)
        horizontalStackView.backgroundColor = UIColor(hex: jackpotModel.promocode_banner_background_color)
        bannerTextLabel.backgroundColor = UIColor(hex: jackpotModel.promocode_banner_background_color)
        bannerButtonLabel.backgroundColor = UIColor(hex: jackpotModel.promocode_banner_background_color)
        bannerCodeLabel.backgroundColor = UIColor(hex: jackpotModel.promocode_banner_background_color)

        bannerTextLabel.textColor = UIColor(hex: jackpotModel.promocode_banner_text_color)
        bannerButtonLabel.textColor = UIColor(hex: jackpotModel.promocode_banner_text_color)
        bannerCodeLabel.textColor = UIColor(hex: jackpotModel.promocode_banner_text_color)
    }
