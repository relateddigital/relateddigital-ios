//
//  RDPlinkoCodeBannerView.swift
//  RelatedDigitalIOS
//
//  RDClawMachineCodeBannerView baz alınmıştır.
//

import UIKit

class RDPlinkoCodeBannerView: UIView {

    var plinkoModel: PlinkoModel
    ...
    init(frame: CGRect, plinkoModel: PlinkoModel) {
        self.plinkoModel = plinkoModel
    ...
    private func setupLabels() {
        ...
        invisibleViewTop.backgroundColor = .clear
        ...
        invisibleViewBottom.backgroundColor = .clear
        ...
        bannerTextLabel.text = plinkoModel.promocode_banner_text.removeEscapingCharacters()
        ...
        bannerButtonLabel.text = plinkoModel.promocode_banner_button_label
        bannerButtonLabel.textAlignment = .center
        bannerButtonLabel.isHidden = true

        bannerCodeLabel = UILabel()
        bannerCodeLabel.text = BannerCodeManager.shared.getPlinkoCode()
    ...
    private func setCloseButton() {
        ...
        closeButton.setTitleColor(plinkoModel.close_button_color.lowercased() == "white" ? .white : .black, for: .normal)
    ...
    private func setFonts() {
        let font = RDHelper.getFont(fontFamily: plinkoModel.font_family,
                                    fontSize: plinkoModel.copybutton_text_size,
                                    style: .title2, customFont: plinkoModel.custom_font_family_ios)
    ...
    private func setColors() {
        self.backgroundColor = UIColor(hex: plinkoModel.promocode_banner_background_color)
        horizontalStackView.backgroundColor = UIColor(hex: plinkoModel.promocode_banner_background_color)
        bannerTextLabel.backgroundColor = UIColor(hex: plinkoModel.promocode_banner_background_color)
        bannerButtonLabel.backgroundColor = UIColor(hex: plinkoModel.promocode_banner_background_color)
        bannerCodeLabel.backgroundColor = UIColor(hex: plinkoModel.promocode_banner_background_color)

        bannerTextLabel.textColor = UIColor(hex: plinkoModel.promocode_banner_text_color)
        bannerButtonLabel.textColor = UIColor(hex: plinkoModel.promocode_banner_text_color)
        bannerCodeLabel.textColor = UIColor(hex: plinkoModel.promocode_banner_text_color)
    }
}
