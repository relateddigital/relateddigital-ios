...
class RDPollCodeBannerView: UIView {
    ...
    init(frame: CGRect, pollModel: PollModel) {
    ...
    private func setupLabels() {
        ...
        bannerTextLabel.text = pollModel.promocode_banner_text.removeEscapingCharacters()
        ...
        bannerButtonLabel.text = pollModel.promocode_banner_button_label
        bannerButtonLabel.textAlignment = .center
        bannerButtonLabel.isHidden = true

        bannerCodeLabel = UILabel()
        bannerCodeLabel.text = BannerCodeManager.shared.getpollCode()
    ...
    private func setCloseButton() {
        ...
        closeButton.setTitleColor(pollModel.close_button_color.lowercased() == "white" ? .white : .black, for: .normal)
    ...
    private func setFonts() {
        let font = RDHelper.getFont(fontFamily: pollModel.font_family,
                                    fontSize: pollModel.copybutton_text_size,
                                    style: .title2, customFont: pollModel.custom_font_family_ios)
    ...
    private func setColors() {
        self.backgroundColor = UIColor(hex: pollModel.promocode_banner_background_color)
        horizontalStackView.backgroundColor = UIColor(hex: pollModel.promocode_banner_background_color)
        bannerTextLabel.backgroundColor = UIColor(hex: pollModel.promocode_banner_background_color)
        bannerButtonLabel.backgroundColor = UIColor(hex: pollModel.promocode_banner_background_color)
        bannerCodeLabel.backgroundColor = UIColor(hex: pollModel.promocode_banner_background_color)

        bannerTextLabel.textColor = UIColor(hex: pollModel.promocode_banner_text_color)
        bannerButtonLabel.textColor = UIColor(hex: pollModel.promocode_banner_text_color)
        bannerCodeLabel.textColor = UIColor(hex: pollModel.promocode_banner_text_color)
    }
