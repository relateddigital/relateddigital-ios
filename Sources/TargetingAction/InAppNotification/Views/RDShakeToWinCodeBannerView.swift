//
//  RDShakeToWinCodeBannerView.swift
//  RelatedDigitalIOS
//
...
class RDShakeToWinCodeBannerView: UIView {
    
    var shakeToWinModel: ShakeToWinViewModel
    ...
    init(frame: CGRect, shakeToWin : ShakeToWinViewModel) {
        self.shakeToWinModel = shakeToWin
    ...
    private func setCloseButton() {
        ...
        closeButton.setTitleColor(shakeToWinModel.mailExtendedProps.buttonColor?.lowercased() == "white" ? .white : .black , for: .normal)
    ...
    private func setFonts() {
        let font = RDHelper.getFont(fontFamily: shakeToWinModel.mailExtendedProps.textFontFamily,
                                    fontSize: shakeToWinModel.mailExtendedProps.textSize,
                                    style: .title2, customFont: shakeToWinModel.mailExtendedProps.textCustomFontFamilyIos)
    ...
    private func setColors() {
        self.backgroundColor = UIColor(hex: shakeToWinModel.promocode_banner_background_color)
        horizontalStackView.backgroundColor = UIColor(hex: shakeToWinModel.promocode_banner_background_color)
        bannerTextLabel.backgroundColor = UIColor(hex: shakeToWinModel.promocode_banner_background_color)
        bannerButtonLabel.backgroundColor = UIColor(hex: shakeToWinModel.promocode_banner_background_color)
        bannerCodeLabel.backgroundColor = UIColor(hex: shakeToWinModel.promocode_banner_background_color)
        
        bannerTextLabel.textColor = UIColor(hex: shakeToWinModel.promocode_banner_text_color)
        bannerButtonLabel.textColor = UIColor(hex: shakeToWinModel.promocode_banner_text_color)
        bannerCodeLabel.textColor = UIColor(hex: shakeToWinModel.promocode_banner_text_color)
    }
