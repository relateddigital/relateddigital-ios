...
final class NotificationBellViewController: RDBaseNotificationViewController, UIGestureRecognizerDelegate {
    ...
    override func show(animated: Bool) {
        guard let sharedUIApplication = RDInstance.sharedUIApplication() else { return }
    ...
    private func applyModel() {
        ...
        panel.titleLabel.font = RDHelper.getFont(fontFamily: model.font_family, fontSize: model.title_text_size ?? "15", style: .title2, customFont: model.font_family)
...
final class BellRowView: UIControl {
    ...
    init(text: String, link: String?,model: NotificationBellModel) {
        ...
        label.font = RDHelper.getFont(fontFamily: model.font_family, fontSize: model.text_text_size ?? "15", style: .title2, customFont: model.font_family)
...
final class NotificationBellPanelView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        closeButton.setImage(RDHelper.getUIImage(named: "VisilabsCloseButtonBlack"), for: .normal)
