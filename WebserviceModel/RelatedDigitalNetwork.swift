...
struct RelatedDigitalBasePath {
    ...
    static func buildURL(visilabsEndpoint: RelatedDigitalEndpoint, queryItems: [URLQueryItem]?) -> URL? {
    ...
    static func getEndpoint(visilabsEndpoint: RelatedDigitalEndpoint) -> String {
